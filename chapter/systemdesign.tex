...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3.4cm}|p{9.6cm}|}
        ...
        \hline
        Flutter and Dart & The Android client: camera capture, frame conversion, the ported preprocessing, the WebSocket protocol for the fallback path, and speech output. \\
        \hline
