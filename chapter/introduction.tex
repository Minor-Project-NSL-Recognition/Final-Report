...
\begin{itemize}
    ...
    \item To deploy the trained model in an application that, on the user's command, captures a sign and displays the recognised phrase and speaks it aloud, and to withhold output when the system is not confident.
\end{itemize}
