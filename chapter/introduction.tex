...
\begin{itemize}
    ...
    \item To deploy the trained model in a mobile application that runs recognition on the device itself, so that no network connection is required at the moment of an emergency, and that on the user's command captures a sign, displays the recognised phrase, speaks it aloud, and withholds output when the system is not confident.
\end{itemize}
