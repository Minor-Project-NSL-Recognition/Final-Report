...
The objective was to build a system that recognises six Nepali Sign Language emergency phrases from a live camera and speaks them aloud. Specifically:
...
\begin{itemize}
    ...
    \item To deploy it as a mobile application that runs offline on the device, displays and speaks the recognised phrase, and stays silent when it is not confident.
\end{itemize}
